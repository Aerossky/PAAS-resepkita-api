<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://resepku.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://s2.coinmarketcap.com/static/img/coins/200x200/24478.png" class="h-8" alt="ResepKu Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ResepKu</span>
        </a>
        ...
        <div class="flex items-center">
            ...
            @else
                <a href="{{ route('login') }}"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-sm text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Login</a>
            @endauth
        </div>
    </div>
</nav>
