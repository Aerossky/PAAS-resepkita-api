...
<head>
    ...
    <title>Resepku | Edit Ingredient</title>
...
<body>
    ...
    <div class="max-w-screen-xl mx-auto px-4 py-8">
        <div id="admin-ingredient-edit" class="mb-8 bg-white shadow-md rounded-lg overflow-hidden border border-gray-200 p-6">

            <div class="flex items-center justify-between">
                <h1 class="font-bold text-2xl py-5">Edit Ingredient</h1>
                <div class="">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div class="mb-4 col-span-2">
                            ...
                            <input type="text" id="name" name="name"
                                class="mt-1 p-2 w-full border rounded-md" value="{{ old('name', $ingredient->name) }}"
                                required>
                        </div>
                        <!-- Tombol Kirim -->
                        <div class="">
