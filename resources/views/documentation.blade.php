        ...
        <div class="flex mx-auto md:w-3/4 md:mt-3 flex-col md:flex-row">
            ...
            <div class="md:hidden bg-white text-black flex flex-col mb-2 md:mb-0" id="mobileDropdown">
                <div class="relative">
                    ...
                    <div id="mobileDropdownContent"
                        class="hidden absolute bg-white rounded-lg mt-1 py-2 w-full shadow-lg">
                        <ul class="w-full">
                            <li>
                                <p class="flex justify-center font-bold text-resep-merah-200">Pendahuluan</p>
                            </li>
                        ...
                        <ul class="w-full">
                            <li>
                                <p class="flex justify-center font-bold text-resep-merah-200">Penggunaan</p>
                            </li>
                            <li><a href="#" class="block py-2 px-10 text-center menuMobile" id="menu3mobile"
                                    onclick="changeContent('menu3')">GET
                                    All Resep</a></li>
            ...
            <div class="flex-1 px-2 md:me-5 m-5 ms-0 md:my-0 md:px-5 md:border-l-2" id="mainContent">
                ...
                <div id="menu1Content" class="container m-auto">
                    <div class="w-fit">
                        ...
                        <p class="text-base md:text-lg mt-5 text-wrap">Selamat datang di dokumentasi <span
                            ...
                            komprehensif dan mudah digunakan untuk mengakses berbagai koleksi resep dari berbagai
                            masakan.
                            Baik Anda sedang membangun aplikasi memasak, mengintegrasikan data resep ke dalam layanan
                            Anda,
                            atau membuat perencana makanan yang dipersonalisasi, API kami menyediakan alat yang Anda
                            butuhkan.</p>
                        <h2 class="text-xl md:text-2xl mt-5 text-wrap font-medium text-resep-merah-200">API ini dibuat
                            oleh
                            :</h2>
                        ...
                        <p class="text-base md:text-lg mt-5 text-wrap">Jika anda mengalami masalah dalam penggunaan API
                            ini,
                            tim dukungan
                ...
                <div id="menu2Content" class="hidden container m-auto">
                    <div>
                        ...
                        <p class="text-base md:text-lg mt-5 text-wrap">Untuk mulai menggunakan API kami, pertama-tama
                            Anda
                        ...
                        <h2 class="text-xl md:text-2xl mt-5 text-wrap font-medium text-resep-merah-200">2. Dapatkan API
                            Key
                        </h2>
                        ...
                        <ul class="ps-5 mt-3 space-y-1 list-disc list-inside text-base md:text-lg">
                            ...
                            <li>Pilih "Copy API Key" dari menu yang muncul untuk menyalin API key Anda ke clipboard.
                            </li>
                        </ul>

                        <h2 class="text-xl md:text-2xl mt-5 text-wrap font-medium text-resep-merah-200">3. Buka
                            Dokumentasi
                        </h2>
                        <p class="text-base md:text-lg mt-5 text-wrap">Setelah mendapatkan API key, buka dokumentasi
                            API
                        ...
                        <h2 class="text-xl md:text-2xl mt-5 text-wrap font-medium text-resep-merah-200">4. Pilih Metode
                            yang
                            Diinginkan</h2>
                        <p class="text-base md:text-lg mt-5 text-wrap">Di dalam dokumentasi, Anda dapat memilih metode
                            atau
                        ...
                        <h2 class="text-xl md:text-2xl mt-5 text-wrap font-medium text-resep-merah-200">5. Ikuti Contoh
                            Pengambilan Data</h2>
                        <p class="text-base md:text-lg mt-5 text-wrap">Setelah memilih metode yang diinginkan, ikuti
                            contoh
                ...
                <div id="menu3Content" class="hidden container m-auto">
                    <div class="md:mb-5">
                        ...
                        <p class="text-base md:text-lg mt-5 text-wrap">Metode ini memungkinkan pengguna untuk mengambil
                            ...
                            pengguna dapat mengakses semua informasi terkait resep, termasuk judul, daftar bahan,
                            petunjuk,
                        ...
                        <div class="mt-2 w-full md:w-fit md:mt-5 relative overflow-x-auto shadow-md sm:rounded-lg">
                            <table class="w-full md:w-fit text-sm text-left rtl:text-right text-gray-500 ">
                                ...
                                <tbody>
                                    <tr class="bg-white border-b ">
                                        <td scope="row"
                                            class="px-6 py-4 text-base md:text-lg text-black border-e-2">
                                            GET
                                        </td>
                        ...
                        <ul class="w-fit flex mt-5">
                            ...
                            <li><button
                                    class="block py-2 w-full px-5 md:w-full md:px-10 text-center md:text-start border"
            ...
            "error": "Unauthorized"
                ...
                <div id="menu4Content" class="hidden container m-auto">
                    <div class="md:mb-5">
                        ...
                        <h2 class="text-xl md:text-2xl mt-5 text-wrap font-medium text-resep-merah-200">Ringkasan</h2>
                        <p class="text-base md:text-lg mt-5 text-wrap">Metode ini memungkinkan pengguna untuk mencari
                            resep
            ...
            "error": "Unauthorized"
                ...
                <div id="menu5Content" class="hidden container m-auto">
                    <div class="md:mb-5">
                        ...
                        <p class="text-base md:text-lg mt-5 text-wrap">Metode ini memungkinkan pengguna untuk mencari
                            resep
                            berdasarkan bahan-bahan tertentu. Pengguna dapat menyediakan daftar bahan yang ingin
                            digunakan
                            dalam
                            resep, dan API akan memberikan respon yang berisi seluruh data resep yang menggunakan
                            setidaknya
                                ...
                                <pre><code class="code-block text-sm text-black whitespace-pre">
    {
        ...
        <script>
            function changeContent(menu) {
                ...
                document.getElementById('mobileDropdownToggleText').innerHTML = document.getElementById(menu + "mobile")
                    .innerHTML;
